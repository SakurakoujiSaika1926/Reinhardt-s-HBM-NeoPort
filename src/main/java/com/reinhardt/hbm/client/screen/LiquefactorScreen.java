...
public class LiquefactorScreen extends AbstractContainerScreen<LiquefactorMenu> {
    ...
    public LiquefactorScreen(LiquefactorMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (isHovering(134, 18, 16, 52, mouseX, mouseY)) {
            guiGraphics.renderComponentTooltip(this.font, List.of(Component.translatable(
                    ...
                    this.menu.energy(),
                    LiquefactorBlockEntity.MAX_POWER
            )), mouseX, mouseY);
        }
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        drawFluid(guiGraphics, 71, 88, 16, this.menu.fluidScaled(52), this.menu.fluid());
    }
