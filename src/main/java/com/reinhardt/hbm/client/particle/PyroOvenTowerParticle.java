...
/** Exact ParticleCoolingTower parameters from the 1.7.10 pyro oven vent. */
public final class PyroOvenTowerParticle extends TextureSheetParticle {
    ...
    private PyroOvenTowerParticle(ClientLevel level, double x, double y, double z,
    ...
    public static final class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z,
            ...
            return new PyroOvenTowerParticle(level, x, y, z, red, green, blue, this.sprites);
        }
    }
}
