...
public final class LegacyPlasmaBlastParticle extends TextureSheetParticle {
    private static final int MAX_AGE = 20;
    private static final float MAX_SCALE = 50.0F;

    private LegacyPlasmaBlastParticle(ClientLevel level, double x, double y, double z, SpriteSet sprites) {
        super(level, x, y, z);
    ...
    public void render(VertexConsumer buffer, Camera camera, float partialTick) {
        ...
        float scale = (float) ((1.0D - Math.exp(progress * -0.125D)) * MAX_SCALE);
    ...
    public AABB getRenderBoundingBox(float partialTicks) {
        return getBoundingBox().inflate(MAX_SCALE, 1.0D, MAX_SCALE);
    }
    ...
    public static final class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            return new LegacyPlasmaBlastParticle(level, x, y, z, this.sprites);
        }
    }
}
