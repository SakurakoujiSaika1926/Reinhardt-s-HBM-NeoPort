...
/** Direct port of the drain's legacy ParticleCoolingTower parameters. */
public final class DrainTowerParticle extends TextureSheetParticle {
    ...
    private DrainTowerParticle(ClientLevel level, double x, double y, double z,
    ...
    public static final class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z,
            ...
            return new DrainTowerParticle(level, x, y, z, red, green, blue, this.sprites);
        }
    }
}
