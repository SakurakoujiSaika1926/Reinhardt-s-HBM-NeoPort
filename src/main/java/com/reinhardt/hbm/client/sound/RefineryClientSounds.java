...
public final class RefineryClientSounds {
    ...
    private RefineryClientSounds() {
    }

    public static void tick(RefineryBlockEntity refinery) {
    ...
    private static final class WorkingSound extends AbstractTickableSoundInstance {
        ...
        public void tick() {
            ...
            if (!(blockEntity instanceof RefineryBlockEntity refinery) || !refinery.isWorking()) {
                requestStop();
                return;
            }
