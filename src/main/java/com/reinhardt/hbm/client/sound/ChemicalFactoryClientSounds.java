...
public final class ChemicalFactoryClientSounds {
    ...
    private ChemicalFactoryClientSounds() {
    }

    public static void tick(ChemicalFactoryBlockEntity factory) {
        Minecraft minecraft = Minecraft.getInstance();
        if (minecraft.level == null || minecraft.player == null || !factory.isClientWorking()) {
            stop(factory.getBlockPos());
            return;
        }

        BlockPos pos = factory.getBlockPos().immutable();
    ...
    private static final class WorkingSound extends AbstractTickableSoundInstance {
        ...
        public void tick() {
            ...
            if (!(blockEntity instanceof ChemicalFactoryBlockEntity factory) || !factory.isClientWorking()) {
                requestStop();
                return;
            }
