...
public final class DieselGeneratorClientSounds {
    ...
    private DieselGeneratorClientSounds() {
    }

    public static void tick(DieselGeneratorBlockEntity diesel) {
        Minecraft minecraft = Minecraft.getInstance();
        if (minecraft.level == null || minecraft.player == null || !diesel.running()) {
            stop(diesel.getBlockPos());
            return;
        }
        BlockPos pos = diesel.getBlockPos().immutable();
    ...
    private static final class WorkingSound extends AbstractTickableSoundInstance {
        ...
        public void tick() {
            ...
            if (!(blockEntity instanceof DieselGeneratorBlockEntity diesel) || !diesel.running()) {
                requestStop();
                return;
            }
