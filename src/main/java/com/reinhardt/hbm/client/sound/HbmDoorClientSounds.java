    ...
    private record Profile(SoundEvent openStart, SoundEvent openLoop, SoundEvent secondaryLoop,
        ...
        private static Profile forDoor(HbmDoorDecl door) {
            return switch (door) {
                ...
                case SLIDING_GATE_DOOR -> new Profile(HbmSoundEvents.DOOR_SLIDING_SEAL_OPEN.get(), null, null, HbmSoundEvents.DOOR_SLIDING_SEAL_STOP.get(), HbmSoundEvents.DOOR_SLIDING_SEAL_OPEN.get(), null, HbmSoundEvents.DOOR_SLIDING_SEAL_STOP.get(), 3.0F);
                ...
                case QE_SLIDING_DOOR -> new Profile(null, HbmSoundEvents.DOOR_QE_SLIDING_OPENING.get(), null, HbmSoundEvents.DOOR_QE_SLIDING_OPENED.get(), null, HbmSoundEvents.DOOR_QE_SLIDING_OPENING.get(), HbmSoundEvents.DOOR_QE_SLIDING_SHUT.get(), 2.0F);
